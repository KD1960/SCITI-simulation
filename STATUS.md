...
**Last updated:** 2026-09-18 (catalog v2 on `main`; E1–E5 rerun on it; 210 tests pass)
**Phase:** MVP merged to `main`; engine corrected after the 2026-09-17 test audit. See README.md for how to use it.
**Next step:** Kevin rules on how chain coalitions should work when suppliers use rules (`docs/sciti2/llm-run-e5-v2.md`, last section). Then: more LLM seeds and a disruption arm; check the shrink baseline (0.2%/week); cost evidence for control tower, APS, and ML forecasting; consider a random-disruption experiment using the evidence table's base rates.
