...
class Assumptions(Strict):
    ...
    # A group adopting a pair or chain technology is one project: one draw at the catalog odds decides fail / partial / full for
    # everyone together; members only draw the depth of their own onboarding. See multi-party-combination-proposal.md section 5 (d).
